...
# def split_tilesize(self, tile_size: tuple[int, int]) -> list[pygame.Surface]:
#         width, height = self.size[0], self.size[1]
#         count_x, count_y = (width // tile_size[0], height // tile_size[1])

#         images = []

#         for y in range(count_y):
#             for x in range(count_x):
#                 images.append(self.image.subsurface(pygame.Rect(x * tile_size[0], y * tile_size[1], tile_size[0], tile_size[1])))
        
#         return images

#     def split_count(self, count: tuple[int, int]) -> list[pygame.Surface]:
#         count_x, count_y = (count[0], count[1])
#         tile_size = (self.size[0] // count_x, self.size[1] // count_y)
